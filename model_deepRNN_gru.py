...
class Attention(object):
    ...
    def init_params(self, options):
        ...
        # decoder: gru
        params = self.layers.get_layer('gru')[0](options,params, nin=options['dim_word'],
                                                  dim=options['tu_dim'], prefix='tu_gru')
        params = self.layers.get_layer('gru_cond')[0](options, params, nin=options['tu_dim'],
    ...
    def build_model(self, tparams, options):
        ...
        # decoder
        tu_gru = self.layers.get_layer('gru')[1](options,tparams, emb, mask=mask, prefix='tu_gru')
        mu_gru = self.layers.get_layer('gru_cond')[1](options, tparams, tu_gru[0],
