...
import model_deepRNN_gru
import model_stochastic_lstm_gru
import model_stochastic_lstm_gru_dou_feat
...
def train_from_scratch(config, state, channel):    
    ...
    if config.model == 'attention':
        model_stochastic_lstm_gru.train_from_scratch(state, channel)
    else:
